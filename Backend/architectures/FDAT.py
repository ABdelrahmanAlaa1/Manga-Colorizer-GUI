...
from .fdat_utils import store_hyperparameters, DropPath
...
class FastSpatialWindowAttention(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        q, k, v = qkv.unbind(0)
        # Use F.scaled_dot_product_attention with position bias as attn_mask.
        # This enables FlashAttention2/efficient SDPA kernels, and when
        # SageAttention is monkey-patched, our safe wrapper handles the
        # attn_mask fallback gracefully.
        x = (
            F.scaled_dot_product_attention(q, k, v, attn_mask=self.bias, scale=self.scale)
            .transpose(1, 2)
